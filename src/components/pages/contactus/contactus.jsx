  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="text-center mb-12">
        <h1 className="text-5xl font-serif italic mb-4">Get in Touch With Us</h1>
        <p className="text-gray-600">We're Here to Answer Your Questions and Support Your Needs</p>
      </div>
